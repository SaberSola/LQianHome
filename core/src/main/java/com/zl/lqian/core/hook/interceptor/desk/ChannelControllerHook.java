package com.zl.lqian.core.hook.interceptor.desk;

import com.zl.lqian.core.hook.interceptor.InterceptorHookSupport;
...
public class ChannelControllerHook extends InterceptorHookSupport {
    ...
    public String[] getInterceptor() {
        //说明要拦截的controller
        return new String[]{"LQianHome.web.controller.site.ChannelController"};
    }
