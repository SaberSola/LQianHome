    ...
    public ConnectionFactory rabbitConnectionFactory() throws Exception{
      ...
      /*  RabbitProperties.Ssl ssl = rabbitProperties.getSsl();
        ...
        if (rabbitProperties.connection_timeout != null) {
            System.out.println("设置链接的超时时间"+Integer.parseInt(rabbitProperties.connection_timeout));
            factory.setConnectionTimeout(Integer.parseInt(rabbitProperties.connection_timeout));
        }
      ...
      /*  if (rabbitProperties.getCache().getConnection().getMode() != null) {
        ...
        if (rabbitProperties.checkout_timeout != null) {
            connectionFactory.setChannelCheckoutTimeout(Integer.parseInt(rabbitProperties.checkout_timeout));
        }
